...
static void help(int exit_code = 1)
{
  ...
  fprintf(stderr, "  --spmpregions=<n>     Number of SPMP regions [default 16]\n");
...
int main(int argc, char** argv)
{
  ...
  parser.option(0, "spmpregions", 1, [&](const char* s){cfg.spmpregions = atoul_safe(s);});
