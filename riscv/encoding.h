...
#define CSR_VSPMPCFG0 0xA00
#define CSR_VSPMPCFG1 0xA01
#define CSR_VSPMPCFG2 0xA02
#define CSR_VSPMPCFG3 0xA03
#define CSR_VSPMPCFG4 0xA04
#define CSR_VSPMPCFG5 0xA05
#define CSR_VSPMPCFG6 0xA06
#define CSR_VSPMPCFG7 0xA07
#define CSR_VSPMPCFG8 0xA08
#define CSR_VSPMPCFG9 0xA09
#define CSR_VSPMPCFG10 0xA0a
#define CSR_VSPMPCFG11 0xA0b
#define CSR_VSPMPCFG12 0xA0c
#define CSR_VSPMPCFG13 0xA0d
#define CSR_VSPMPCFG14 0xA0e
#define CSR_VSPMPCFG15 0xA0f
#define CSR_VSPMPADDR0 0xA10
#define CSR_VSPMPADDR1 0xA11
#define CSR_VSPMPADDR2 0xA12
#define CSR_VSPMPADDR3 0xA13
#define CSR_VSPMPADDR4 0xA14
#define CSR_VSPMPADDR5 0xA15
#define CSR_VSPMPADDR6 0xA16
#define CSR_VSPMPADDR7 0xA17
#define CSR_VSPMPADDR8 0xA18
#define CSR_VSPMPADDR9 0xA19
#define CSR_VSPMPADDR10 0xA1a
#define CSR_VSPMPADDR11 0xA1b
#define CSR_VSPMPADDR12 0xA1c
#define CSR_VSPMPADDR13 0xA1d
#define CSR_VSPMPADDR14 0xA1e
#define CSR_VSPMPADDR15 0xA1f
#define CSR_VSPMPADDR16 0xA20
#define CSR_VSPMPADDR17 0xA21
#define CSR_VSPMPADDR18 0xA22
#define CSR_VSPMPADDR19 0xA23
#define CSR_VSPMPADDR20 0xA24
#define CSR_VSPMPADDR21 0xA25
#define CSR_VSPMPADDR22 0xA26
#define CSR_VSPMPADDR23 0xA27
#define CSR_VSPMPADDR24 0xA28
#define CSR_VSPMPADDR25 0xA29
#define CSR_VSPMPADDR26 0xA2a
#define CSR_VSPMPADDR27 0xA2b
#define CSR_VSPMPADDR28 0xA2c
#define CSR_VSPMPADDR29 0xA2d
#define CSR_VSPMPADDR30 0xA2e
#define CSR_VSPMPADDR31 0xA2f
#define CSR_VSPMPADDR32 0xA30
#define CSR_VSPMPADDR33 0xA31
#define CSR_VSPMPADDR34 0xA32
#define CSR_VSPMPADDR35 0xA33
#define CSR_VSPMPADDR36 0xA34
#define CSR_VSPMPADDR37 0xA35
#define CSR_VSPMPADDR38 0xA36
#define CSR_VSPMPADDR39 0xA37
#define CSR_VSPMPADDR40 0xA38
#define CSR_VSPMPADDR41 0xA39
#define CSR_VSPMPADDR42 0xA3a
#define CSR_VSPMPADDR43 0xA3b
#define CSR_VSPMPADDR44 0xA3c
#define CSR_VSPMPADDR45 0xA3d
#define CSR_VSPMPADDR46 0xA3e
#define CSR_VSPMPADDR47 0xA3f
#define CSR_VSPMPADDR48 0xA40
#define CSR_VSPMPADDR49 0xA41
#define CSR_VSPMPADDR50 0xA42
#define CSR_VSPMPADDR51 0xA43
#define CSR_VSPMPADDR52 0xA44
#define CSR_VSPMPADDR53 0xA45
#define CSR_VSPMPADDR54 0xA46
#define CSR_VSPMPADDR55 0xA47
#define CSR_VSPMPADDR56 0xA48
#define CSR_VSPMPADDR57 0xA49
#define CSR_VSPMPADDR58 0xA4a
#define CSR_VSPMPADDR59 0xA4b
#define CSR_VSPMPADDR60 0xA4c
#define CSR_VSPMPADDR61 0xA4d
#define CSR_VSPMPADDR62 0xA4e
#define CSR_VSPMPADDR63 0xA4f

#define CSR_VSPMPSWITCH0 0xA50
#define CSR_VSPMPSWITCH1 0xA51
...
DECLARE_CSR(spmpcfg0, CSR_SPMPCFG0)
DECLARE_CSR(spmpcfg1, CSR_SPMPCFG1)
DECLARE_CSR(spmpcfg2, CSR_SPMPCFG2)
DECLARE_CSR(spmpcfg3, CSR_SPMPCFG3)
DECLARE_CSR(spmpcfg4, CSR_SPMPCFG4)
DECLARE_CSR(spmpcfg5, CSR_SPMPCFG5)
DECLARE_CSR(spmpcfg6, CSR_SPMPCFG6)
DECLARE_CSR(spmpcfg7, CSR_SPMPCFG7)
DECLARE_CSR(spmpcfg8, CSR_SPMPCFG8)
DECLARE_CSR(spmpcfg9, CSR_SPMPCFG9)
DECLARE_CSR(spmpcfg10, CSR_SPMPCFG10)
DECLARE_CSR(spmpcfg11, CSR_SPMPCFG11)
DECLARE_CSR(spmpcfg12, CSR_SPMPCFG12)
DECLARE_CSR(spmpcfg13, CSR_SPMPCFG13)
DECLARE_CSR(spmpcfg14, CSR_SPMPCFG14)
DECLARE_CSR(spmpcfg15, CSR_SPMPCFG15)
DECLARE_CSR(spmpaddr0, CSR_SPMPADDR0)
DECLARE_CSR(spmpaddr1, CSR_SPMPADDR1)
DECLARE_CSR(spmpaddr2, CSR_SPMPADDR2)
DECLARE_CSR(spmpaddr3, CSR_SPMPADDR3)
DECLARE_CSR(spmpaddr4, CSR_SPMPADDR4)
DECLARE_CSR(spmpaddr5, CSR_SPMPADDR5)
DECLARE_CSR(spmpaddr6, CSR_SPMPADDR6)
DECLARE_CSR(spmpaddr7, CSR_SPMPADDR7)
DECLARE_CSR(spmpaddr8, CSR_SPMPADDR8)
DECLARE_CSR(spmpaddr9, CSR_SPMPADDR9)
DECLARE_CSR(spmpaddr10, CSR_SPMPADDR10)
DECLARE_CSR(spmpaddr11, CSR_SPMPADDR11)
DECLARE_CSR(spmpaddr12, CSR_SPMPADDR12)
DECLARE_CSR(spmpaddr13, CSR_SPMPADDR13)
DECLARE_CSR(spmpaddr14, CSR_SPMPADDR14)
DECLARE_CSR(spmpaddr15, CSR_SPMPADDR15)
DECLARE_CSR(spmpaddr16, CSR_SPMPADDR16)
DECLARE_CSR(spmpaddr17, CSR_SPMPADDR17)
DECLARE_CSR(spmpaddr18, CSR_SPMPADDR18)
DECLARE_CSR(spmpaddr19, CSR_SPMPADDR19)
DECLARE_CSR(spmpaddr20, CSR_SPMPADDR20)
DECLARE_CSR(spmpaddr21, CSR_SPMPADDR21)
DECLARE_CSR(spmpaddr22, CSR_SPMPADDR22)
DECLARE_CSR(spmpaddr23, CSR_SPMPADDR23)
DECLARE_CSR(spmpaddr24, CSR_SPMPADDR24)
DECLARE_CSR(spmpaddr25, CSR_SPMPADDR25)
DECLARE_CSR(spmpaddr26, CSR_SPMPADDR26)
DECLARE_CSR(spmpaddr27, CSR_SPMPADDR27)
DECLARE_CSR(spmpaddr28, CSR_SPMPADDR28)
DECLARE_CSR(spmpaddr29, CSR_SPMPADDR29)
DECLARE_CSR(spmpaddr30, CSR_SPMPADDR30)
DECLARE_CSR(spmpaddr31, CSR_SPMPADDR31)
DECLARE_CSR(spmpaddr32, CSR_SPMPADDR32)
DECLARE_CSR(spmpaddr33, CSR_SPMPADDR33)
DECLARE_CSR(spmpaddr34, CSR_SPMPADDR34)
DECLARE_CSR(spmpaddr35, CSR_SPMPADDR35)
DECLARE_CSR(spmpaddr36, CSR_SPMPADDR36)
DECLARE_CSR(spmpaddr37, CSR_SPMPADDR37)
DECLARE_CSR(spmpaddr38, CSR_SPMPADDR38)
DECLARE_CSR(spmpaddr39, CSR_SPMPADDR39)
DECLARE_CSR(spmpaddr40, CSR_SPMPADDR40)
DECLARE_CSR(spmpaddr41, CSR_SPMPADDR41)
DECLARE_CSR(spmpaddr42, CSR_SPMPADDR42)
DECLARE_CSR(spmpaddr43, CSR_SPMPADDR43)
DECLARE_CSR(spmpaddr44, CSR_SPMPADDR44)
DECLARE_CSR(spmpaddr45, CSR_SPMPADDR45)
DECLARE_CSR(spmpaddr46, CSR_SPMPADDR46)
DECLARE_CSR(spmpaddr47, CSR_SPMPADDR47)
DECLARE_CSR(spmpaddr48, CSR_SPMPADDR48)
DECLARE_CSR(spmpaddr49, CSR_SPMPADDR49)
DECLARE_CSR(spmpaddr50, CSR_SPMPADDR50)
DECLARE_CSR(spmpaddr51, CSR_SPMPADDR51)
DECLARE_CSR(spmpaddr52, CSR_SPMPADDR52)
DECLARE_CSR(spmpaddr53, CSR_SPMPADDR53)
DECLARE_CSR(spmpaddr54, CSR_SPMPADDR54)
DECLARE_CSR(spmpaddr55, CSR_SPMPADDR55)
DECLARE_CSR(spmpaddr56, CSR_SPMPADDR56)
DECLARE_CSR(spmpaddr57, CSR_SPMPADDR57)
DECLARE_CSR(spmpaddr58, CSR_SPMPADDR58)
DECLARE_CSR(spmpaddr59, CSR_SPMPADDR59)
DECLARE_CSR(spmpaddr60, CSR_SPMPADDR60)
DECLARE_CSR(spmpaddr61, CSR_SPMPADDR61)
DECLARE_CSR(spmpaddr62, CSR_SPMPADDR62)
DECLARE_CSR(spmpaddr63, CSR_SPMPADDR63)

DECLARE_CSR(spmpswitch0, CSR_SPMPSWITCH0)
DECLARE_CSR(spmpswitch1, CSR_SPMPSWITCH1)

DECLARE_CSR(vspmpcfg0, CSR_VSPMPCFG0)
DECLARE_CSR(vspmpcfg1, CSR_VSPMPCFG1)
DECLARE_CSR(vspmpcfg2, CSR_VSPMPCFG2)
DECLARE_CSR(vspmpcfg3, CSR_VSPMPCFG3)
DECLARE_CSR(vspmpcfg4, CSR_VSPMPCFG4)
DECLARE_CSR(vspmpcfg5, CSR_VSPMPCFG5)
DECLARE_CSR(vspmpcfg6, CSR_VSPMPCFG6)
DECLARE_CSR(vspmpcfg7, CSR_VSPMPCFG7)
DECLARE_CSR(vspmpcfg8, CSR_VSPMPCFG8)
DECLARE_CSR(vspmpcfg9, CSR_VSPMPCFG9)
DECLARE_CSR(vspmpcfg10, CSR_VSPMPCFG10)
DECLARE_CSR(vspmpcfg11, CSR_VSPMPCFG11)
DECLARE_CSR(vspmpcfg12, CSR_VSPMPCFG12)
DECLARE_CSR(vspmpcfg13, CSR_VSPMPCFG13)
DECLARE_CSR(vspmpcfg14, CSR_VSPMPCFG14)
DECLARE_CSR(vspmpcfg15, CSR_VSPMPCFG15)
DECLARE_CSR(vspmpaddr0, CSR_VSPMPADDR0)
DECLARE_CSR(vspmpaddr1, CSR_VSPMPADDR1)
DECLARE_CSR(vspmpaddr2, CSR_VSPMPADDR2)
DECLARE_CSR(vspmpaddr3, CSR_VSPMPADDR3)
DECLARE_CSR(vspmpaddr4, CSR_VSPMPADDR4)
DECLARE_CSR(vspmpaddr5, CSR_VSPMPADDR5)
DECLARE_CSR(vspmpaddr6, CSR_VSPMPADDR6)
DECLARE_CSR(vspmpaddr7, CSR_VSPMPADDR7)
DECLARE_CSR(vspmpaddr8, CSR_VSPMPADDR8)
DECLARE_CSR(vspmpaddr9, CSR_VSPMPADDR9)
DECLARE_CSR(vspmpaddr10, CSR_VSPMPADDR10)
DECLARE_CSR(vspmpaddr11, CSR_VSPMPADDR11)
DECLARE_CSR(vspmpaddr12, CSR_VSPMPADDR12)
DECLARE_CSR(vspmpaddr13, CSR_VSPMPADDR13)
DECLARE_CSR(vspmpaddr14, CSR_VSPMPADDR14)
DECLARE_CSR(vspmpaddr15, CSR_VSPMPADDR15)
DECLARE_CSR(vspmpaddr16, CSR_VSPMPADDR16)
DECLARE_CSR(vspmpaddr17, CSR_VSPMPADDR17)
DECLARE_CSR(vspmpaddr18, CSR_VSPMPADDR18)
DECLARE_CSR(vspmpaddr19, CSR_VSPMPADDR19)
DECLARE_CSR(vspmpaddr20, CSR_VSPMPADDR20)
DECLARE_CSR(vspmpaddr21, CSR_VSPMPADDR21)
DECLARE_CSR(vspmpaddr22, CSR_VSPMPADDR22)
DECLARE_CSR(vspmpaddr23, CSR_VSPMPADDR23)
DECLARE_CSR(vspmpaddr24, CSR_VSPMPADDR24)
DECLARE_CSR(vspmpaddr25, CSR_VSPMPADDR25)
DECLARE_CSR(vspmpaddr26, CSR_VSPMPADDR26)
DECLARE_CSR(vspmpaddr27, CSR_VSPMPADDR27)
DECLARE_CSR(vspmpaddr28, CSR_VSPMPADDR28)
DECLARE_CSR(vspmpaddr29, CSR_VSPMPADDR29)
DECLARE_CSR(vspmpaddr30, CSR_VSPMPADDR30)
DECLARE_CSR(vspmpaddr31, CSR_VSPMPADDR31)
DECLARE_CSR(vspmpaddr32, CSR_VSPMPADDR32)
DECLARE_CSR(vspmpaddr33, CSR_VSPMPADDR33)
DECLARE_CSR(vspmpaddr34, CSR_VSPMPADDR34)
DECLARE_CSR(vspmpaddr35, CSR_VSPMPADDR35)
DECLARE_CSR(vspmpaddr36, CSR_VSPMPADDR36)
DECLARE_CSR(vspmpaddr37, CSR_VSPMPADDR37)
DECLARE_CSR(vspmpaddr38, CSR_VSPMPADDR38)
DECLARE_CSR(vspmpaddr39, CSR_VSPMPADDR39)
DECLARE_CSR(vspmpaddr40, CSR_VSPMPADDR40)
DECLARE_CSR(vspmpaddr41, CSR_VSPMPADDR41)
DECLARE_CSR(vspmpaddr42, CSR_VSPMPADDR42)
DECLARE_CSR(vspmpaddr43, CSR_VSPMPADDR43)
DECLARE_CSR(vspmpaddr44, CSR_VSPMPADDR44)
DECLARE_CSR(vspmpaddr45, CSR_VSPMPADDR45)
DECLARE_CSR(vspmpaddr46, CSR_VSPMPADDR46)
DECLARE_CSR(vspmpaddr47, CSR_VSPMPADDR47)
DECLARE_CSR(vspmpaddr48, CSR_VSPMPADDR48)
DECLARE_CSR(vspmpaddr49, CSR_VSPMPADDR49)
DECLARE_CSR(vspmpaddr50, CSR_VSPMPADDR50)
DECLARE_CSR(vspmpaddr51, CSR_VSPMPADDR51)
DECLARE_CSR(vspmpaddr52, CSR_VSPMPADDR52)
DECLARE_CSR(vspmpaddr53, CSR_VSPMPADDR53)
DECLARE_CSR(vspmpaddr54, CSR_VSPMPADDR54)
DECLARE_CSR(vspmpaddr55, CSR_VSPMPADDR55)
DECLARE_CSR(vspmpaddr56, CSR_VSPMPADDR56)
DECLARE_CSR(vspmpaddr57, CSR_VSPMPADDR57)
DECLARE_CSR(vspmpaddr58, CSR_VSPMPADDR58)
DECLARE_CSR(vspmpaddr59, CSR_VSPMPADDR59)
DECLARE_CSR(vspmpaddr60, CSR_VSPMPADDR60)
DECLARE_CSR(vspmpaddr61, CSR_VSPMPADDR61)
DECLARE_CSR(vspmpaddr62, CSR_VSPMPADDR62)
DECLARE_CSR(vspmpaddr63, CSR_VSPMPADDR63)
